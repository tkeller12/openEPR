...
from PyQt6.QtWidgets import (QApplication, QMainWindow, QWidget, QGridLayout, QLabel,
                             QLineEdit, QComboBox, QCheckBox, QPushButton, QStatusBar,
                             QMessageBox)
...
class TxrGUI(QMainWindow):
    ...
    def init_ui(self) -> None:
        ...
        self.freq_input.setPlaceholderText("e.g., 2400000")
    ...
    def apply_settings(self) -> None:
        ...
        try:
            ...
            try:
                ...
                raise ValueError("Invalid frequency value. Must be a number.")
    ...
    def closeEvent(self, event) -> None:
        ...
        if self.txr:
            try:
                ...
                logger.warning(f"Error closing transceiver: {e}")
        event.accept()
